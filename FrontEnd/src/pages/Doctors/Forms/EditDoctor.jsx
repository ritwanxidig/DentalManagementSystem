...
import { update, getAll } from "../../../ApiServices/CrudeApiCalls";
...
const EditDoctor = ({ onClose, selectedDoctor }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      await update(`/Doctors/${selectedDoctor.id}`, values)
        .then((res) => {
          alert(res);
      ...
      <div className="bg-white max-w-md mx-auto rounded shadow-2xl drop-shadow-2xl overflow-hidden">
        <div className="p-12">
          <div className="flex justify-between items-center mb-2 border-b-2 my-3 -mt-8">
            <h1 className="text-2xl font-light">Edit Doctor</h1>
            <button
