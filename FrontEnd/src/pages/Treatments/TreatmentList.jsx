...
import ToPrintTreatment from "./Forms/ToPrintTreatment";
...
const TreatmentsList = () => {
  ...
  const handlePrint = (props) => {
    ...
    printWindow.document.write(
      "<html><head><title>Treatment Letter</title> <script src='https://cdn.tailwindcss.com'></script></head><body>"
    );
    printWindow.document.write(
      ReactDOMServer.renderToString(
        <ToPrintTreatment selectedTreatment={props} />
      )
    );
    ...
    <div className="control-pane m-2 md:mx-10 p-2 md:p-10 bg-white drop-shadow-xl rounded-lg">
      ...
      {Data && Data.length > 0 ? (
        ...
        >
          <ColumnsDirective>
            <ColumnDirective
              field="treatmentPlan.invoiceNo"
              headerText="Invoice Code"
              width={190}
              textAlign="center"
            ></ColumnDirective>
            <ColumnDirective
              field="prescription.patient.patientName"
              headerText="Patient"
              width={180}
              textAlign="Left"
            ></ColumnDirective>
            <ColumnDirective
              field="prescription.patient.phoneNo"
              headerText="Patient Phone No"
              width={150}
            ></ColumnDirective>
            <ColumnDirective
              field="createdAt"
