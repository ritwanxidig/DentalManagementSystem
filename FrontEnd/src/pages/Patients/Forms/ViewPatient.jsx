...
import avatar2 from "../../../data/images/pngegg (1).png";

const ViewPatient = ({ onClose, selectedPatient }) => {
  return (
    <div
      ...
      <div className="bg-white max-w-5xl mx-auto rounded shadow-2xl drop-shadow-2xl overflow-hidden">
        <div className="px-4 pb-12">
          <div className="flex justify-between items-center mb-2 border-b-2 my-3">
            <h1 className="text-2xl font-light">Patient Details</h1>
            <button
          ...
          <div className="flex w-full justify-center items-center my-4">
              <img
                src={avatar2}
                alt={`${selectedPatient.name}'s Image`}
            ...
            <div className="flex flex-col justify-start mt-4 gap-2">
              ...
              <h1 className="capitalize text-gray-600">
                Age:
                <span className="text-black mx-2">{selectedPatient.age}</span>
              </h1>
              <h1 className="text-gray-600">
                Gender:
                <span className="text-black mx-2"> {selectedPatient.sex}</span>
              </h1>
              <h1 className="text-gray-600">
                Phone No:
                <span className="text-black mx-2">
