...
import ViewPatient from "./Forms/ViewPatient";
  ...
  return (
    <div className="control-pane m-2 md:mx-10 p-2 md:p-10 bg-white drop-shadow-xl rounded-lg">
      <div className="p-4 flex justify-between">
        <div>
          <h1 className="text-3xl font-semibold tracking-tight">Patients Management</h1>
      ...
      {AddIsOpen && <AddPatient onClose={() => setAddIsOpen(false)} />}
      {EditIsOpen && (
        <EditPatient
      ...
      {Data && Data.length > 0 ? (
        ...
        <p> There's no data for doctors </p>
      )}
    </div>
  );
};
